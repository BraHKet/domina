    ...
    <div style={{
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '12px',
              border: 'none',
              background: drawMode === 'competitor' ? 'linear-gradient(135deg, #10B981, #059669)' : 'rgba(255, 255, 255, 0.02)',
              boxShadow: drawMode === 'competitor' ? '0 4px 14px rgba(16, 185, 129, 0.4)' : 'none',
              cursor: 'pointer',
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '12px',
              border: 'none',
              background: drawMode === 'opportunita' ? 'linear-gradient(135deg, #FBBF24, #D97706)' : 'rgba(255, 255, 255, 0.02)',
              boxShadow: drawMode === 'opportunita' ? '0 4px 14px rgba(251, 191, 36, 0.4)' : 'none',
              cursor: 'pointer',
              transition: 'all 0.2s ease',
              width: '100%',
            }}
      ...
      <div style={{
        ...
        <label style={{
          ...
          alignItems: 'center',
          gap: '8px',
          background: soloNuovi ? 'rgba(16, 185, 129, 0.15)' : 'rgba(13, 17, 23, 0.75)',
          border: soloNuovi ? '1.5px solid #10B981' : '1px solid rgba(255, 255, 255, 0.08)',
          borderRadius: '12px',
          padding: '8px 14px',
          cursor: 'pointer',
        ...
        <label style={{
          ...
          alignItems: 'center',
          gap: '8px',
          background: soloSeguiti ? 'rgba(251, 191, 36, 0.15)' : 'rgba(13, 17, 23, 0.75)',
          border: soloSeguiti ? '1.5px solid #FBBF24' : '1px solid rgba(255, 255, 255, 0.08)',
          borderRadius: '12px',
          padding: '8px 14px',
          cursor: 'pointer',
          backdropFilter: 'blur(8px)',
        ...
        <button
          ...
          style={{
            ...
            alignItems: 'center',
            gap: '6px',
            background: seguitiCount > 0 ? 'rgba(34, 197, 94, 0.12)' : 'rgba(255, 255, 255, 0.02)',
            border: seguitiCount > 0 ? '1.5px solid rgba(34, 197, 94, 0.4)' : '1.5px solid rgba(255, 255, 255, 0.05)',
            borderRadius: '12px',
            padding: '8px 14px',
            color: seguitiCount > 0 ? '#22C55E' : '#4B5563',
